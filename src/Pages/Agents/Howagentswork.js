                ...
                <Container>
                    <Row className='d-flex align-items-center'>
                        <Col md={6}>
                            ...
                            <p>Match with sellers looking to list for 1% No Referral Fees No Monthly Contracts</p>
                        </Col>
                                        ...
                                        {steps.map((step, index) => (
                                            <Step key={step.label} className='hiw-agent-steps'>
                                                ...
                                                <StepContent className='agent-steps-desc'>
                                                    ...
                                                    <Box sx={{ mb: 2 }}>
                                                        <div>
                                                            <Button variant="contained" onClick={handleNext} sx={{ mt: 1, mr: 1 }} className='hiw-agent-step-btn'>
                                        ...
                                        {seller_steps.map((step, index) => (
                                            <Step key={step.label} className='hiw-seller-steps'>
                                                ...
                                                <StepContent className='seller-steps-desc'>
                                                    ...
                                                    <Box sx={{ mb: 2 }}>
                                                        <div>
                                                            <Button variant="contained" onClick={sellerhandleNext} sx={{ mt: 1, mr: 1 }} className='hiw-seller-step-btn'>
                                                                {index === seller_steps.length - 1 ? 'Finish' : 'Next'}
                                                            </Button>
                                                        </div>
                                                    </Box>
                                                </StepContent>
                        ...
                        <Col>
                            ...
                            <Accordion defaultActiveKey="0">
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header className='hiw-agent-acordian-btn'>What is Listelligent?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header className='hiw-agent-acordian-btn'>Am I required to list for 1%?</Accordion.Header>
                                    <Accordion.Body>Yes. Not all sellers can or want to pay more than 1%. We ask that you honor the offer Listelligent provides.</Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="2">
                                    <Accordion.Header className='hiw-agent-acordian-btn'>Are there any referral fees owed to Listelligent?</Accordion.Header>
                                    <Accordion.Body>None! Most online platforms will take a referral fee upon close and any other business that     lead generates. Not on Listelligent. So, if the client sells or buys multiple times, you keep 100%.</Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="3">
                                    <Accordion.Header className='hiw-agent-acordian-btn'>How do I buy zip codes?</Accordion.Header>
                                    <Accordion.Body>Once you create a profile you can start purchasing zip codes. You can buy a share of a zip code or the whole zip. We offer two options which are: month to month or 1 year upfront for a discount.</Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="4">
                                    <Accordion.Header className='hiw-agent-acordian-btn'>What makes Listelligent different from other sites?</Accordion.Header>
                                    <Accordion.Body>We have reduced the amount of steps it takes for sellers to get to an agent and begin conversation. Most sites flood the seller with questions or calls prior to even getting to the agent's profile. Our process is simple.  Enter address, contact info and they immediately get matched with the agent in that zip code.</Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="5">
                                    <Accordion.Header className='hiw-agent-acordian-btn'>Is Listelligent nationwide?</Accordion.Header>
